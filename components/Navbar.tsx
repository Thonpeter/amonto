    ...
    >
      <div className="container max-w-screen-xl mx-auto flex justify-between items-center px-4 py-3">
        ...
        <Link href="/" className="flex items-center space-x-3 group">
          ...
          <span
            className={`text-xl sm:text-2xl font-bold hidden sm:block transition-all duration-500 ${
        ...
        <ul className="hidden lg:flex items-center space-x-1 text-lg">
          {navItems.map((item) => (
            <li key={item.name} className="relative">
              <Link
                href={item.path}
                className={`relative py-3 px-4 transition duration-300 flex items-center ${
              ...
              >
                {item.name}
                <span
                  className={`absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-accent transition-all duration-500 ${
                    activeItem === item.path ? "w-2/3" : "hover:w-2/3"
                  }`}
                ></span>
              </Link>
            </li>
        ...
        >
          <div className="w-10 h-10 flex items-center justify-center overflow-hidden">
            <div
              className={`w-7 flex flex-col items-center justify-center transition-all duration-500 ${
